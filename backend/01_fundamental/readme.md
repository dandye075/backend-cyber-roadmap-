...
Bagian dari **Backend Roadmap – Fundamental Programming**  
Target: Menyelesaikan 4 topik utama Python sebelum lanjut ke tahap berikutnya.
...
### Tuple
- ✅ Sudah selesai: definisi (immutable), cara membuat, akses index positif/negatif, slicing, fungsi bawaan (`len`, `sum`, `min`, `max`).  
...
📌 Catatan: Milestone **List** dan **Tuple** selesai. Besok lanjut ke **Set**.
